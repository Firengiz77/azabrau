...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/admin-logout',[AuthController::class,'logout'])->middleware('admin')->name('logout');
    ...
    Route::get('/admin-delete/{id}',[AuthController::class,'admin_delete'])->middleware('admin')->name('delete');
